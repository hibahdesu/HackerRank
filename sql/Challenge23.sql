...
the code of its senior manager, the lead_manager_code is the code of its lead manager,
and the company_code is the code of the working company. 
...
FROM
    ...
    LEFT JOIN Manager AS m ON sm.senior_manager_code = m.senior_manager_code 
                            ...
                            AND lm.company_code = m.company_code
    LEFT JOIN Employee AS e ON m.manager_code = e.manager_code 
                            ...
                            AND lm.company_code = e.company_code
GROUP BY
